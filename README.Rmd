...
What UCINET is calling "Whole Network" is misleading. It's measuring the "extended" ego networks (order = 2).

"Whole Network" may be representative of the other "Whole Network" Structural Holes measures it produces, but it's not relevant to Burt's Constraint.
